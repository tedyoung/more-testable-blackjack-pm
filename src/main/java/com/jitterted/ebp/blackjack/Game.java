...
public class Game {
  ...
  private void displayGameState() {
    clearScreen();
    displayDealerInPlayHand();
    displayPlayerHand();
  }

  private void displayDealerInPlayHand() {
    displayDealerUpCard();
    // second card is the hole card, which is hidden
    displayBackOfDealerHoleCard();
  }
  ...
  private void displayBackOfDealerHoleCard() {
    System.out.print(
        ansi()
            .cursorUp(7)
            .cursorRight(12)
